...
-- © Itzik Ben-Gan 
-- CT: These are subquery examples used in the chapter.
---------------------------------------------------------------------
...
-- Compacts the two select statements from above. Note that the alias in the inner query is not required.
SELECT orderid, orderdate, empid, custid
FROM Sales.Orders
