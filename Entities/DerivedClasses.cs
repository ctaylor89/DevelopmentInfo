...
namespace DevelopmentInfo.Entities
{
    ...
    // declared member of an abstract class. Having an abstract method is not required.
    public abstract class Messages
    {
        ...
        //{
        //    Console.WriteLine("From XXZ class: {0}", msg);
        //}   
    ...
    public class BaseClass
    {
        ...
        // Virtual auto-implemented property. Overriding properties can only
    ...
    public class DerivedClass : BaseClass
    {
        ...
        {
            Console.WriteLine("Derived - Method3. In turn calls base.Method3()");
    ...
    public class DerivedClass2 : DerivedClass
    {
        ...
        public override void Method3()
        {
            Console.WriteLine("Derived 2 - Method3. In turn calls base.Method3()");
            base.Method3();  // Call into the previous parent class
        }
